                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 mb-5">
                    ...
                    <div class="bg-white/90 backdrop-blur-sm rounded-lg shadow-md p-4 border-l-4 border-emerald-500 hover:shadow-lg transition-all">
                        <div class="flex items-start justify-between mb-2">
                            ...
                            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Active Members</p>
              https://github.com/JIAN-LESTER/gym-app-ipt/pull/36/conflict?name=resources%252Fviews%252Fadmin%252Fdashboard.blade.php&ancestor_oid=a387ecd75759e5ee08e72796757c62be380397e5&base_oid=3de9c76a3ac166c4c80e2113ccad38821417b634&head_oid=bd78467b52c11c87df97d3cc2a5ff64cadf6878c              <h3 class="text-3xl font-black text-gray-900">{{ $totalActiveMembers }}</h3>
                            <div class="flex items-center gap-2 mt-1">
                                <span class="inline-flex items-center text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">+{{ $newMembersThisMonth }} this month</span>
                            </div>
                            @if($expiringMemberships > 0)
