    ...
    <body class="bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 min-h-screen">
        <div class="w-full px-4 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <!-- Active Members Card -->
                <div
                    class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-all hover:scale-105 duration-200">
                ...
                <!-- Gym Occupancy Card -->
                <div
                    class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-all hover:scale-105 duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div
                    class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-all hover:scale-105 duration-200">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div
                    class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-all hover:scale-105 duration-200">
                    <div class="flex items-center justify-between">
                        <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="space-y-3">
                                <div class="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg">
                                    ...
                                    <p class="text-2xl font-bold text-blue-600">
                                        ₱{{ number_format($revenueBreakdown['products'], 2) }}</p>
                                </div>
                                <div class="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-lg">
                                    <p class="text-sm text-gray-600 mb-1">Membership Sales</p>
                                    <p class="text-2xl font-bold text-green-600">
                                        ₱{{ number_format($revenueBreakdown['memberships'], 2) }}</p>
                                </div>
                                <div
                                    class="bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-lg border-2 border-purple-300">
                                    <p class="text-sm text-gray-600 mb-1">Total Revenue</p>
                                    <p class="text-2xl font-bold text-purple-600">
                                        ₱{{ number_format($revenueBreakdown['total'], 2) }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div
                                class="border-2 border-green-200 rounded-lg p-4 bg-gradient-to-br from-green-50 to-emerald-50">
                            ...
                            <!-- Most Popular Plan -->
                            <div
                                class="border-2 border-purple-200 rounded-lg p-4 bg-gradient-to-br from-purple-50 to-pink-50">
                                <div class="flex items-center mb-2">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="space-y-3">
                            <div
                                class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                                <div class="flex items-center">
                            ...
                            <div
                                class="flex items-center justify-between p-3 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg border border-red-200">
                                <div class="flex items-center">
                            ...
                            <div
                                class="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border border-blue-200">
                                <div class="flex items-center">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="space-y-3 max-h-72 overflow-y-auto">
                            @forelse($membersByPlan as $planData)
                                <div
                                    class="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg hover:shadow-md transition-shadow">
                                    <div>
                            ...
                            @forelse($recentSales as $sale)
                                <div class="p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all hover:shadow-md">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span
                                            class="font-bold text-green-600">₱{{ number_format($sale->total_amount, 2) }}</span>
                                    </div>
                                    <div class="flex flex-wrap gap-1">
                                        @foreach($sale->items as $item)
                                            @if($item->product)
                                                <span
                                                    class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded">{{ $item->product->name }}</span>
                                            @elseif($item->plan)
                                                <span
                                                    class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded">{{ $item->plan->name }}</span>
                                            @endif
                                        @endforeach
                                    </div>
                                </div>
        ...
        <script>
                ...
                fetch(`{{ route('admin.dashboard') }}?ajax=1&sales_period=${period}`, {
                    ...
                    .catch(error => {
                        ...
                        if (typeof toastr !== 'undefined') {
                            toastr.error('Failed to update sales trend chart');
                        }
                    });
            }
            ...
            function updateMembershipTrendChart(period) {
                ...
                fetch(`{{ route('admin.dashboard') }}?ajax=1&membership_period=${period}`, {
                    ...
                    .catch(error => {
                        ...
                        if (typeof toastr !== 'undefined') {
                            toastr.error('Failed to update membership trend chart');
                        }
                    });
            }
            ...
            // Initialize Sales Breakdown Chart (this one doesn't need AJAX)
