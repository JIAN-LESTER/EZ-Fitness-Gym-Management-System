...
'profile.edit','profile.update','profile.complete-member-profile','admin.users-create',
'admin.users-store','admin.show','admin.users-edit','admin.update','admin.users-destroy',
...
'transactions.index','transactions.show','admin.user_management','verification.send','admin.plan_management',
'plans.store','plans.update','plans.destroy','verification.verify','logs.show',
'check.username','check.email','storage.local',);
...
'admin.transactions','admin.user-management','authentication.login','authentication.register','emails.member_qr',
'layouts.app','member.dashboard','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
