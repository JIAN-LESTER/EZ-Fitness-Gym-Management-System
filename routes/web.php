...
Route::prefix('admin')->middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // Today's check-ins (AJAX)
        Route::get('/attendance/today-checkins', [AttendanceController::class, 'todayCheckins'])
            ->middleware('admin')
            ->name('attendance.today.checkins');
